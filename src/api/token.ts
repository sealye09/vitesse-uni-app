...
export const setToken = (token: string) => uni.setStorageSync(STORAGE_TOKEN_KEY, token);
...
export const getRefreshToken = () => uni.getStorageSync(STORAGE_REFRESH_TOKEN_KEY);
export const removeRefreshToken = () => uni.removeStorageSync(STORAGE_REFRESH_TOKEN_KEY);
